				...
				<div className="container">
					<div className="row">
						...
						<div className="col-lg-5">
							<p>
								Obtenga toda la información más reciente sobre
								eventos, ventas y ofertas.
							</p>
							<h5>
								Reciba un cupón de $ 10 para la primera compra.
							</h5>
						</div>
			...
			<footer>
				<div className="container">
					...
					<div className="footer-bottom">
						<p>
							© {appName}. {new Date().getFullYear()}. Reservados
							todos los derechos
						</p>
